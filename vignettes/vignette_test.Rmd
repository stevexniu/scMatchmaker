...
Lastly, we compare the base model (x axis) against the EMD model (y axis).


```{r comparison, fig.height=3, fig.width=4, fig.align="center"}
plot(x = decidua.interaction@strength, y = decidua.interaction.emd@strength, xlab = "Base Model", ylab = "EMD Adjusted")
